...
#define BRD_DEBUG_UART_TX_PIN				GPIO_PIN_10
#define BRD_DEBUG_UART_TX_GPIO_PORT			GPIOB
#define __BRD_DEBUG_UART_TX_GPIO_CLK()		__GPIOB_CLK_ENABLE()

#define BRD_DEBUG_UART_RX_AF				GPIO_AF7_USART3
#define BRD_DEBUG_UART_RX_PIN				GPIO_PIN_10
#define BRD_DEBUG_UART_RX_GPIO_PORT			GPIOB
#define __BRD_DEBUG_UART_RX_GPIO_CLK()		__GPIOB_CLK_ENABLE()
...
#define LED_ENABLE()	__HAL_RCC_GPIOA_CLK_ENABLE()

#define	BUTTON_PIN			GPIO_PIN_13
#define	BUTTON_PORT			GPIOC
#define BUTTON_EXTI_IRQn	EXTI15_10_IRQn
#define BUTTON_ENABLE()		__HAL_RCC_GPIOC_CLK_ENABLE()
